import {
  package_default
} from "./chunk-EHPQOVGR.js";
import {
  selectSvgElement
} from "./chunk-7UGKIA2X.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-OETKWHRX.js";
import {
  registerLayoutLoaders
} from "./chunk-WCT4OD7P.js";
import "./chunk-KOQ4NKFW.js";
import "./chunk-JN42UD6I.js";
import "./chunk-GT7JNEK5.js";
import "./chunk-2PXC5JHR.js";
import "./chunk-3K6DSNK7.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-TO25K2NB.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
  ...
  removeDirectives,
  utils_default
} from "./chunk-2B5CORYY.js";
import "./chunk-56R6R5AS.js";
import {
  UnknownDiagramError,
  addDirective,
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-R7DCKIK5.js";
import {
  __name,
  log,
  select_default,
  setLogLevel
} from "./chunk-ZYR422D7.js";
import {
  compile,
  serialize,
  stringify
} from "./chunk-RXA6NZQD.js";
import {
  isEmpty_default
} from "./chunk-4T4EXWLC.js";
import "./chunk-3S6PURUH.js";
import "./chunk-6OM5ZVOX.js";
import "./chunk-PKQFHU4B.js";
import "./chunk-RYMSYSVQ.js";
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-YG6GDRKO-ZCLIZTNW.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-NV44I4VS-HMWBDXOP.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-Q2GNP2WA-43HK6H3V.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-NY62KEGX-HQVXWYGL.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-LVOFAZNH-O54TPACT.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-ER5ION4S-R7V6NJF6.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-ADFJNKIX-3N4N5O2C.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-AYHSOK5B-ARV3NSTW.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-PRI3JC2R-KZWJX27Q.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-UZGBJVZJ-NRPN6GZL.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-WL72ISMW-ZCTX27JI.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-2ON5EDUG-SEWDDURZ.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-WZHVMYZB-Z5V24VCP.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-FKZM4ZOC-IWE7JOUR.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-4FDKWEC3-7MXMM552.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-XKPGCS4Q-XT4S5R63.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-IT6M3QCI-UUAAJ7MB.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-VGOIOE7T-2G65RFJI.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-3W4ZIXB7-SGDMDBXA.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-TZEHDZUN-YUINXN3X.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-S2PKOQOG-RV22TWW7.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-QEK2KX5R-NHFUR3SB.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-VD42YOAC-HZCNVTHG.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-VXUJARFQ-KNGZ4HRM.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-PSM6KHXK-NKOMXFHT.js");
...
var parse2 = __name(async (text, parseOptions) => {
...
mermaid/dist/mermaid.core.mjs:
   ...
   *)
*/
//# sourceMappingURL=mermaid.core-GPPIL7QK.js.map
